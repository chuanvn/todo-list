...
/* harmony import */ var _content_list_list_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./content/list/list.component */ "./src/app/content/list/list.component.ts");
...
var routes = [
    ...
    { path: 'todo', component: _content_list_list_component__WEBPACK_IMPORTED_MODULE_4__["ListComponent"], canActivate: [_auth_guard__WEBPACK_IMPORTED_MODULE_8__["AuthGuard"]] },
    { path: 'home', component: _home_home_component__WEBPACK_IMPORTED_MODULE_5__["HomeComponent"] },
    { path: 'about', component: _about_about_component__WEBPACK_IMPORTED_MODULE_6__["AboutComponent"] },
    { path: 'login', component: _login_login_component__WEBPACK_IMPORTED_MODULE_7__["LoginComponent"] },
    { path: 'todo/:id', component: _content_edit_edit_component__WEBPACK_IMPORTED_MODULE_3__["EditComponent"] }
];
...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.ngOnInit = function () {
        console.log(_environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"]);
    };
...
/* harmony import */ var _shared_interceptors_jwt_interceptor__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./shared/interceptors/jwt.interceptor */ "./src/app/shared/interceptors/jwt.interceptor.ts");
...
/* harmony import */ var _content_list_list_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./content/list/list.component */ "./src/app/content/list/list.component.ts");
/* harmony import */ var _content_add_add_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./content/add/add.component */ "./src/app/content/add/add.component.ts");
/* harmony import */ var _content_edit_edit_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./content/edit/edit.component */ "./src/app/content/edit/edit.component.ts");
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
            declarations: [
                ...
                _content_list_list_component__WEBPACK_IMPORTED_MODULE_10__["ListComponent"],
                _content_add_add_component__WEBPACK_IMPORTED_MODULE_11__["AddComponent"],
                _content_edit_edit_component__WEBPACK_IMPORTED_MODULE_12__["EditComponent"],
            ...
            providers: [
                { provide: _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HTTP_INTERCEPTORS"], useClass: _shared_interceptors_jwt_interceptor__WEBPACK_IMPORTED_MODULE_5__["JwtInterceptor"], multi: true }
            ],
...
module.exports = "<form action=\"\">\n  <div class=\"form-group\">\n    <input type=\"text\" class=\"form-control\" (keyup)=\"onKey()\" placeholder=\"What do you want to do?\"\n      [(ngModel)]=\"Task.text\" name=\"text\">\n  </div>\n\n  <div class=\"form-group\">\n    <button [ngClass]=\"{'btn': true, 'btn-primary': true, 'disabled': isButtonDisabled ? true : false}\"\n      class=\"btn btn-primary\" (click)=\"addTask();\">Add</button>\n  </div>\n</form>\n"
...
module.exports = "<form action=\"\">\n  <div class=\"form-group\">\n    <input type=\"text\" class=\"form-control\" [(ngModel)]=\"Task.text\" name=\"text\">\n  </div>\n\n  <div class=\"form-group\">\n      <button [ngClass]=\"{'btn': true, 'btn-primary': true, 'disabled': isButtonDisabled ? true : false}\" class=\"btn btn-primary\" (click)=\"updateTask(Task)\">Update</button>\n  </div>\n</form>\n"
...
var EditComponent = /** @class */ (function () {
    function EditComponent(todo, route) {
        this.todo = todo;
        this.route = route;
    ...
    EditComponent.prototype.updateTask = function (Task) {
        var _this = this;
        this.todo.edit(Task).subscribe(function (res) {
            _this.Tasks = res;
        });
    };
    EditComponent.prototype.getTask = function () {
        var _this = this;
        this.todo.view(this.taskId).subscribe(function (res) {
            _this.Task = res;
        });
    };
    EditComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_services_todo_service__WEBPACK_IMPORTED_MODULE_2__["TodoService"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["ActivatedRoute"]])
    ], EditComponent);
...
var ListComponent = /** @class */ (function () {
    ...
    ListComponent.prototype.getTasks = function () {
        ...
        this.todo.getList().subscribe(function (res) {
            _this.Tasks = res;
            _this.numTask = _this.Tasks.length;
        });
    };
...
module.exports = "<div class=\"container\">\n  <button routerLink=\"/home\" routerLinkActive=\"active\" class=\"btn btn-default\">Home</button>\n  <button routerLink=\"/about\" routerLinkActive=\"active\" class=\"btn btn-default\">About</button>\n  <button routerLink=\"/todo\" routerLinkActive=\"active\" class=\"btn btn-default\">Todo</button>\n  <a (click)=\"logout()\" *ngIf=\"isLoggedIn\">Logout</a>\n</div>\n\n"
...
var HeaderComponent = /** @class */ (function () {
    ...
    HeaderComponent.prototype.checkLoggedIn = function () {
        if (localStorage.getItem('currentUser')) {
...
module.exports = "<div class=\"container\">\n  <div class=\"row\">\n    <div class=\"col-md-6 col-md-offset-3\">\n      <form action=\"\">\n        <div class=\"form-group\">\n          <label for=\"username\">Username</label>\n          <input type=\"text\" [(ngModel)]=\"userInfo.username\" name=\"username\" class=\"form-control\">\n        </div>\n\n        <div class=\"form-group\">\n          <label for=\"username\">Password</label>\n          <input type=\"password\" [(ngModel)]=\"userInfo.password\" name=\"password\" class=\"form-control\">\n        </div>\n\n        <div class=\"form-group\">\n          <button class=\"btn btn-primary\" (click)=\"login()\">Login</button>\n        </div>\n      </form>\n    </div>\n  </div>\n</div>\n"
...
var TodoService = /** @class */ (function () {
    ...
    TodoService.prototype.view = function (id) {
        var url = this.urlTask + "/" + id;
